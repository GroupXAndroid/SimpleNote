...
public class ArchiveActivity extends AppCompatActivity implements NoteListener {
    ...
    private NoteArchiveAdapter noteAdapter;
    ImageView imageBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageBack = findViewById(R.id.imageArchiveBack);
        ...
        noteAdapter = new NoteArchiveAdapter(noteList, this);
    ...
    private void getNotes() {
        ...
        notes = NoteDatabase.getSNoteDatabase(getApplicationContext())
                .noteDao().getNoteByStatus(Const.NoteStatus.ARCHIVE);
        if (noteList.size() == 0) {
